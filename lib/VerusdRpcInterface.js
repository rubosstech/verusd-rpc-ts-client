        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            destination_iterator: for (const path of paths) {
                ...
                addConvertable(fullCurrencyDefinition.currencyid, {
                    ...
                    exportto: gateway
                        ? (VerusdRpcInterface.extractRpcResult(yield this.getCachedCurrency(fullCurrencyDefinition.systemid)))
                        : (via == null && fullCurrencyDefinition.systemid === src.systemid) ||
                            ...
                            : via == null
                                ...
                                : via.systemid === root.systemid
                                    ? undefined
                                    : (VerusdRpcInterface.extractRpcResult(yield this.getCachedCurrency(via.systemid))),
                    price,
                    gateway,
                    viapriceinroot,
                    destpriceinvia
                ...
                for (const reserve of src.currencies) {
                    ...
                    if (!ignoreCurrencies.includes(reserve)) {
                        ...
                        addConvertable(reserve, {
                            ...
                            exportto: gateway
                                ? (VerusdRpcInterface.extractRpcResult(yield this.getCachedCurrency(_destination.systemid)))
